...
CAPTION_REPL = {
    "ジーティーオー": "GTO", "イーブイ": "EV", "イーキュー": "EQ", "ビービー": "bb",
    "リブラタス": "Libratus", "プルリバス": "Pluribus", "ケフェウス": "Cepheus",
    "ヘッズアップ": "ヘッズアップ",
}


# 字幕の漢数字 → 算用数字（出現フレーズを狙い撃ち。慣用句 一番/五分五分 は残す）
NUM_REPL = [
    ("二千十五年", "2015年"), ("二千十七年", "2017年"), ("二千十九年", "2019年"),
    ("三分の二", "3分の2"), ("三分の一", "3分の1"),
    ("三回に二回", "3回に2回"), ("三回に一回", "3回に1回"),
    ("二対一", "2対1"),
    ("一年", "1年"), ("二年", "2年"),
    ("一つずつ", "1つずつ"), ("一つに", "1つに"), ("一つ", "1つ"),
    ("ひとつ", "1つ"), ("ふたつ", "2つ"), ("みっつ", "3つ"),
]


def clean_caption(s):
    """字幕表示用に整える：読点を減らし、用語を英字・数字表記へ。"""
